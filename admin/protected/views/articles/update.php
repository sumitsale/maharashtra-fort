...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<br>
		<img src="<?php echo Yii::app()->homeurl  . '/../../admin/images/articles/popular/'. $model->thumbnail_popular ?>">	
	...
	<div class="row">
		...
		<br>
		<img src="<?php echo Yii::app()->homeurl  . '/../../admin/images/articles/recent/'. $model->thumbnail_recent ?>">
